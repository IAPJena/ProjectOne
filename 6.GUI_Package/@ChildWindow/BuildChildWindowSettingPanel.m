function BuildChildWindowSettingPanel(childWindow,parentWindow)
    ...
    txtNumberOfSteps  = uicontrol(...
        ...
        'HorizontalAlignment', 'left');
    %----------------------------------------------------------------------
    % UIcontrols for spot diagram plus
    chkShowAiryDisc = uicontrol( ...
        'Tag', 'chkShowAiryDisc', ...
        'FontSize',fontSize,'FontName', 'FixedWidth',...
        'Visible','off',...
        'Style', 'checkbox', ...
        'String', 'Show Airy Disc',...
        'Value',0);
   
    lblShowPupilRadialDependence  = uicontrol(...
        'Tag', 'lblShowPupilRadialDependence', ...
        'Style', 'text', ...
        'FontSize',fontSize,'FontName', 'FixedWidth',...
        'String', 'Radial Dependence', ...
        'Visible','off',...
        'HorizontalAlignment', 'left');
    popShowPupilRadialDependence  = uicontrol(...
        'Tag', 'popShowPupilRadialDependence', ...
        'Style', 'popupmenu', ...
        'FontSize',fontSize,'FontName', 'FixedWidth',...
        'String', {'None','Dot Color','Dot Size'}, ...
        'BackgroundColor', [1 1 1], ...
        'Visible','off',...
        'HorizontalAlignment', 'left');
    
    lblShowPupilAzimuthalDependence  = uicontrol(...
        'Tag', 'lblShowPupilAzimuthalDependence', ...
        'Style', 'text', ...
        'FontSize',fontSize,'FontName', 'FixedWidth',...
        'String', 'Azimuthal Dependence', ...
        'Visible','off',...
        'HorizontalAlignment', 'left');
    popShowPupilAzimuthalDependence  = uicontrol(...
        'Tag', 'popShowPupilAzimuthalDependence', ...
        'Style', 'popupmenu', ...
        'FontSize',fontSize,'FontName', 'FixedWidth',...
        'String', {'None','Dot Color','Dot Size'}, ...
        'BackgroundColor', [1 1 1], ...
            ...
            switch lower(myName)
                ...
                case lower( 'spotDiagramPlus')
                    ...
                    set(chkShowAiryDisc,...
                        ...
                        'Visible','on',...
                        'Enable','off',...
                        'Position', [0.53 0.68 0.20 0.09]);
                    childHandle.chkShowAiryDisc = chkShowAiryDisc;
                    %-------------------------------------------------------
                    set(lblShowPupilRadialDependence,...
                        'Parent', childHandle.SettingTab, ...
                        'Units', 'normalized', ...
                        'Visible','on',...
                        'Position', [0.02 0.55 0.15 0.09]);
                    childHandle.lblShowPupilRadialDependence = lblShowPupilRadialDependence;
                    set(popShowPupilRadialDependence,...
                        'Parent', childHandle.SettingTab, ...
                        'Units', 'normalized', ...
                        'Visible','on',...
                        'Position', [0.22 0.58 0.25 0.07],...
                        'Value',2);
                    childHandle.popShowPupilRadialDependence = popShowPupilRadialDependence;
                    
                    set(lblShowPupilAzimuthalDependence,...
                        'Parent', childHandle.SettingTab, ...
                        'Units', 'normalized', ...
                        'Visible','on',...
                        'Position', [0.53 0.55 0.20 0.09]);
                    childHandle.lblShowPupilAzimuthalDependence = lblShowPupilAzimuthalDependence;
                    set(popShowPupilAzimuthalDependence,...
                        'Parent', childHandle.SettingTab, ...
                        'Units', 'normalized', ...
                        'Visible','on',...
                        'Position', [0.73 0.58 0.25 0.07],...
                        'Value',1);
                    childHandle.popShowPupilAzimuthalDependence = popShowPupilAzimuthalDependence;
    ...
    set(popShowPupilAzimuthalDependence, ...
        'Callback',{@popShowPupilAzimuthalDependence_Callback,childWindow,parentWindow});

    set(popShowPupilRadialDependence, ...
        'Callback',{@popShowPupilRadialDependence_Callback,childWindow,parentWindow});
    ...
    function popShowPupilAzimuthalDependence_Callback(hObject,~,childWindow,parentWindow)
        parentHandle = parentWindow.ParentHandles;
        childHandle = childWindow.ChildHandles;
        showPupilAzimuthalDependenceList = cellstr (get(hObject,'String'));
        showPupilAzimuthalDependenceString = (showPupilAzimuthalDependenceList{get(hObject,'Value')});
        switch lower(showPupilAzimuthalDependenceString)
            case lower('Dot Color')
                if (get(childHandle.popShowPupilRadialDependence,'Value') == 2)
                    set(childHandle.popShowPupilRadialDependence,'Value',1);
                end                
            case lower('Dot Size')
                if (get(childHandle.popShowPupilRadialDependence,'Value') == 3)
                    set(childHandle.popShowPupilRadialDependence,'Value',1);
                end 
        end
    end
    
    function popShowPupilRadialDependence_Callback(hObject,~,childWindow,parentWindow)
        parentHandle = parentWindow.ParentHandles;
        childHandle = childWindow.ChildHandles;
        showPupilRadialDependenceList = cellstr (get(hObject,'String'));
        showPupilRadialDependenceString = (showPupilRadialDependenceList{get(hObject,'Value')});
        switch lower(showPupilRadialDependenceString)
            case lower('Dot Color')
                if (get(childHandle.popShowPupilAzimuthalDependence,'Value') == 2)
                    set(childHandle.popShowPupilAzimuthalDependence,'Value',1);
                end                
            case lower('Dot Size')
                if (get(childHandle.popShowPupilAzimuthalDependence,'Value') == 3)
                    set(childHandle.popShowPupilAzimuthalDependence,'Value',1);
                end 
        end
    end
