function InitializeMenuAndToolbarItems(parentWindow)
    ...
    aodHandles.menuSpotDiagramPlus = uimenu( ...
        'Parent', aodHandles.menuOpticalSystemAnalysis, ...
        'Tag', 'menuSpotDiagramPlus', ...
        'Label', 'Spot Diagram Plus', ...
        'Checked', 'off', ...
        'Callback', {@menuSpotDiagramPlus_Callback,parentWindow});
...
% ---------------------------------------------------------------------
function menuSpotDiagramPlus_Callback(~,~,parentWindow)
    ChildWindow('SpotDiagramPlus',parentWindow);
end
